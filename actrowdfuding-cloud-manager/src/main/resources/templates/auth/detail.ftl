        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                   <#list mcs as mc>
                       <h1>${mc.certname}</h1>
                       <img src="${APP_PATH}/img/down/${mc.iconpath}">
                   </#list>
                   <br>
                   <button type="button" class="btn btn-primary" style="float:right;margin-right:40px;" ><i class="glyphicon glyphicon-off"></i> 审核不通过</button>
                   <button type="button" onclick="doOK()" class="btn btn-primary" style="float:right;margin-right:40px;" ><i class="glyphicon glyphicon-upload"></i> 审核通过</button>
                </div>
              </div>
            </div>
        </div>
